...
if __name__ =="__main__":
	...
	fb15k237 = build_data(name = 'FB15k-237',path = tools.cur_path + '/datasets/')


	#SGD hyper-parameters:
	params = Parameters(learning_rate = 0.7,
						max_iter = 1000, 
						batch_size = int(len(fb15k237.train.values) / 100),  #Make 100 batches
						neg_ratio = 1, 
	...
	all_params = { "TTransRESCAL_Logistic_Model" : params } ; emb_size = 150; lmbda =0.5
	...
	fb15k237.grid_search_on_all_models(all_params, embedding_size_grid = [emb_size], lmbda_grid = [lmbda], nb_runs = 1)

	#Print best averaged metrics:
	fb15k237.print_best_MRR_and_hits()
