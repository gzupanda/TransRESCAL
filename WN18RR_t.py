...
if __name__ =="__main__":
	...
	wn18rr = build_data(name = 'WN18RR',path = tools.cur_path + '/datasets/')


	#SGD hyper-parameters:
	params = Parameters(learning_rate = 0.5, 
						max_iter = 1000, 
						batch_size = int(len(wn18rr.train.values) / 200),  #Make 100 batches
						neg_ratio = 1, 
	...
	all_params = { "TTransRESCAL_Logistic_Model" : params } ; emb_size = 20; lmbda =0.01
	...
	wn18rr.grid_search_on_all_models(all_params, embedding_size_grid = [emb_size], lmbda_grid = [lmbda], nb_runs = 1)

	#Print best averaged metrics:
	wn18rr.print_best_MRR_and_hits()

	#Print best averaged metrics per relation:
	wn18rr.print_best_MRR_and_hits_per_rel()